...
/* ============================================================
   STAT STRIP  (4 cards, same as dashboard)
============================================================ */
.stat-strip{
    display:grid;
...
.sc-2::after{background:#d97706;}
.sc-3::after{background:#a855f7;}
.sc-4::after{background:#ef4444;}
...
.sc-2 .stat-icon{background:rgba(217,119,6,.12);}
.sc-3 .stat-icon{background:rgba(168,85,247,.12);}
.sc-4 .stat-icon{background:rgba(239,68,68,.12);}
...
<aside class="sidebar">
    ...
    <nav class="nav-section">
        ...
        <a href="../health_records.php"><span class="nav-icon">📋</span>Health Records</a>
...
<main class="main">
    ...
    <div class="stat-strip">
        ...
        <div class="stat-card sc-2">
            <div class="stat-icon">🧓</div>
            <div class="stat-info">
                <h4><?= number_format($totalSenior) ?></h4>
                <p>Senior Citizens</p>
            </div>
        </div>
        ...
        <div class="stat-card sc-4">
            <div class="stat-icon">💊</div>
            <div class="stat-info">
                <h4><?= number_format($totalChronic) ?></h4>
                <p>Chronic Illness</p>
            </div>
        </div>
    </div>
    ...
    <div class="table-card">
        ...
        <div class="table-header">
            ...
            <a href="add.php" class="add-btn-header">＋ New Patient</a>
        </div>
